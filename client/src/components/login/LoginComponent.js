        ...
        <LoginContainer onSubmit={handleSubmit(onSubmit)}>
          <Formblock>
            ...
            <div className="input--container">
              <Input
                className={errors.email && errors.email.type === 'required' && 'invalid-input'}
                type="email"
                id="email"
                {...register('email', {
                  required: true,
              ...
              <svg
                ...
                aria-hidden="true"
                className={
                  errors.email && errors.email.type === 'required' && 'invalid-input--icon'
                }
                width="18"
                height="18"
                viewBox="0 0 18 18"
          ...
          <Formblock>
            ...
            <div className="input--container">
              <Input
                className={
                  errors.password && errors.password.type === 'required' && 'invalid-input'
                }
                type="password"
                id="password"
                {...register('password', {
              ...
              <svg
                ...
                aria-hidden="true"
                className={
                  errors.password && errors.password.type === 'required' && 'invalid-input--icon'
                }
                width="18"
                height="18"
                viewBox="0 0 18 18"
